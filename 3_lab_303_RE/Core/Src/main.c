...
int main(void)
{
 ...
 __HAL_DMA_DISABLE_IT(&hdma_usart2_rx, DMA_IT_HT);
  ...
  /* add threads, ... */
  xTaskCreate(Task1, "led1-2", configMINIMAL_STACK_SIZE, NULL, 1, NULL);
  xTaskCreateStatic(Task2, "led3-4", configMINIMAL_STACK_SIZE, NULL, 1, task2_stack, &task2_TCB);
